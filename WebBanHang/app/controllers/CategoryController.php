...
class CategoryController
{
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if (empty($errors)) {
                try {
                    ...
                    header("Location: /ptpm-mnm-2280603415/WebBanHang/Category/list");
                    exit();
                } catch (Exception $e) {
    ...
    public function delete($id)
    {
        try {
            ...
            header("Location: /ptpm-mnm-2280603415/WebBanHang/Category/list?error=Xóa danh mục thất bại: " . urlencode($e->getMessage()));
            exit();
        }
    }
}
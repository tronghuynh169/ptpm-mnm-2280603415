...
<div class="container mt-5">
    ...
    <div class="card shadow-sm p-4">
        <form method="POST" action="/ptpm-mnm-2280603415/WebBanHang/Category/edit/<?php echo $category->id; ?>" onsubmit="return validateForm();">
            <div class="mb-3">
            ...
            <div class="d-flex justify-content-between">
                ...
                <a href="/ptpm-mnm-2280603415/WebBanHang/Category/list" class="btn btn-outline-secondary px-4">Quay lại danh sách danh mục</a>
            </div>
        </form>
    </div>
</div>

...
<div class="container mt-5">
    ...
    <a href="/ptpm-mnm-2280603415/WebBanHang/Category/add" class="btn btn-primary mb-4">Thêm danh mục mới</a>
        ...
        <?php foreach ($categories as $category): ?>
            <div class="card">
                ...
                <div class="d-flex justify-content-end gap-2">
                    <a href="/ptpm-mnm-2280603415/WebBanHang/Category/edit/<?php echo $category->id; ?>" class="btn btn-primary btn-sm">Sửa</a>
                    <a href="/ptpm-mnm-2280603415/WebBanHang/Category/delete/<?php echo $category->id; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Bạn có chắc chắn muốn xóa danh mục này?')">Xóa</a>
                </div>
            </div>
        <?php endforeach; ?>
    <?php else: ?>
